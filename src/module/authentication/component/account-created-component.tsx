...
export default class AccountCreatedComponent extends React.Component<IAccountCreatedComponentProps> {
	...
	public static defaultProps = { email: "your email" };
	...
	public render() {
		...
		return (
			<div className="container">
				<p>You're almost done! We sent an activation mail to {email}.
					Please follow the instructions in the mail to activate your account.</p>
